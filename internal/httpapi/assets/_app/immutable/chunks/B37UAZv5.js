import{b as B,i as P,d as v,a as C,g as I,c as L}from"./RlwTk4a5.js";import{h as s,c as E,f as m,ao as M,b as R,E as j,Q as F,J as V,a4 as q,e as N,d as w,m as D,Y as G,R as J,ap as O,p as Q,a as Y,A as _,B as H,y as K,C as U,_ as X,I as Z,V as S,aq as $}from"./Bj2bBXHx.js";import{h as W,e as ee,j as te,d as ae}from"./CkDwQ9a-.js";import{B as se,p as d,r as re}from"./BmCodMXc.js";function oe(n,e,o,c,u,b){let k=s;s&&E();var t=null;s&&m.nodeType===M&&(t=m,E());var i=s?m:n,h=new se(i,!1);R(()=>{const a=e()||null;var f=J;if(a===null){h.ensure(null,null),v(!0);return}return h.ensure(a,g=>{if(a){if(t=s?t:F(a,f),B(t,t),c){var r=null;s&&P(a)&&t.append(r=document.createComment(""));var l=s?V(t):t.appendChild(q());s&&(l===null?N(!1):w(l)),c(t,l),r==null||r.remove()}D.nodes.end=t,g.before(t)}s&&w(g)}),v(!0),()=>{a&&v(!1)}},j),G(()=>{v(!0)}),k&&(N(!0),w(i))}/**
 * @file
