import{b as z,i as P,a as y,d as B,c as L}from"./In_r4Pg7.js";import{h as s,c as C,f as k,an as M,b as R,E as j,Q as F,K as G,a3 as I,e as E,d as m,m as V,X as q,R as D,ao as K,p as O,a as Q,G as v,n as X,C as Z,o as H,Z as J,q as U,V as N,ap as Y}from"./BkxjBBuX.js";import{h as S,e as $,j as ee,f as te}from"./C8_aVuaD.js";import{B as ae,p as d,r as se}from"./BPAE2Pgv.js";function re(n,e,o,c,u,_){let b=s;s&&C();var t=null;s&&k.nodeType===M&&(t=k,C());var i=s?k:n,h=new ae(i,!1);R(()=>{const a=e()||null;var f=D;if(a===null){h.ensure(null,null);return}return h.ensure(a,g=>{if(a){if(t=s?t:F(a,f),z(t,t),c){var r=null;s&&P(a)&&t.append(r=document.createComment(""));var l=s?G(t):t.appendChild(I());s&&(l===null?E(!1):m(l)),c(t,l),r==null||r.remove()}V.nodes.end=t,g.before(t)}s&&m(g)}),()=>{}},j),q(()=>{}),b&&(E(!0),m(i))}/**
 * @file
