import{a as L,i as M,j as v,b as N,k as P,c as B}from"./CJ8HoDHC.js";import{h as s,b as E,d as w,aq as j,q,E as F,i as I,g as O,a5 as R,y as S,s as m,c as D,_ as G,N as K,ar as V,p as Y,a as Z,M as _,K as H,k as J,L as Q,Z as U,O as X,Y as W,as as $}from"./C7gullkJ.js";import{a as C,e as ee,g as te,f as ae}from"./CVP0B6vV.js";import{B as se,p as d,r as re}from"./B1iv2Hrb.js";function oe(n,e,o,c,u,k){let b=s;s&&E();var t=null;s&&w.nodeType===j&&(t=w,E());var i=s?w:n,h=new se(i,!1);q(()=>{const a=e()||null;var f=K;if(a===null){h.ensure(null,null),v(!0);return}return h.ensure(a,g=>{if(a){if(t=s?t:I(a,f),L(t,t),c){var r=null;s&&M(a)&&t.append(r=document.createComment(""));var l=s?O(t):t.appendChild(R());s&&(l===null?S(!1):m(l)),c(t,l),r==null||r.remove()}D.nodes.end=t,g.before(t)}s&&m(g)}),v(!0),()=>{a&&v(!1)}},F),G(()=>{v(!0)}),b&&(S(!0),m(i))}/**
 * @file
