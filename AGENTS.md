...
| Web design consistency remainder: one `SegmentedControl` (4 implementations), dead shadcn primitives (Card/Badge/Separator, 0 consumers), per-route Vault register, the 780/820 breakpoint seam, splitting Viewer/+layout/LibraryView | ⬜ open |
