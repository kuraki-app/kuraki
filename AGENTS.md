...
| Web design remainder: per-route Vault treatment (mono data columns, dense tables, Overview stat tiles) and splitting Viewer (741) / `+layout` (486) / LibraryView (454) | ⬜ open |
