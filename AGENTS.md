...
| Web viewer focus management (no focus into the dialog, no trap, restore only vacuous) | ⬜ open — `test.fixme` in `e2e/viewer.spec.ts`, closes with the Phase 2 dialog unification |
